import { divisions, constraints, types } from "./constants";
...
export const assetDescendants: PathOptionTreeNode[] = [
  {
    id: ['designation', 'item', 'classification', 'templateClass', 'classIdentity'],        // KEYS: tracked, lineage, info, rules
...
export const pathOptionTree: PathOptionTreeNode = {
  ...
  descendants: [
    ...
    {
      id: ['classIdentity'],
      tooltip: 'The <b>class</b> from which the <b>target</b>’s <b>class</b> depends, OR the <b>target</b>’s <b>class</b> if no template',
      type: ['string'],
      ...
      descendants: [
        {
          ...
          descendants: [
            ...
            {
              id: ['ranks'],
              tooltip: 'The available <b>rank</b>s of the <b>stat</b>',
              type: ['object'],
              writable: ['remove']
            },
            {
    ...
    {
      id: ['constraints'],
      tooltip: 'The <b>tag</b>/<b>keyword</b>(s), or combinations thereof, that must or must not exist on included <b>asset</b>s',
      type: ['object'],
      icon: 'constraintsSettings',
      descendants: [
        {
          id: constraints,
          tooltip: '',
                  ...
                  descendants: [
                    ...
                    },
                    {
                      ...
                      descendants: [
                        ...
                        {
                          id: ['array'],
                          tooltip: 'Result in string array form',
                          type: ['array'],
                          icon: '',
                        },
                        {
