...
export const pathOptionTree: PathOptionTreeNode = {
  ...
  descendants: [
    {
      id: ['quantity'],
      tooltip: 'Set the quantity of the <b>target</b> <b>asset</b>',
      type: ['number'],
    ...
    {
      id: ['disallowed'],
      tooltip: 'The <b>asset</b>s that are not allowed to be <b>includ</b>ed, whether or not their <b>class</b> allows them',
      type: ['string'],
      writable: ['add','remove'],
      icon: '',
    },
